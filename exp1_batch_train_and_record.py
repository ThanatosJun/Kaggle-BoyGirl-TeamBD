...
def main():
    parser = argparse.ArgumentParser(
        description="Batch train configs and write summary metrics to experiment_record.csv"
    )
    parser.add_argument(
        "--config-glob",
        default="configs/exp1_*_method*.yaml",
        help="Glob pattern for config files",
    )
    parser.add_argument(
        "--output-csv",
        default="experiments/experiment_record.csv",
